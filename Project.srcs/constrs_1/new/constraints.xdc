...
#set_property PACKAGE_PIN W15 [get_ports {master_reset}]					
...
set_property PACKAGE_PIN U16 [get_ports {addr_LEDs[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_LEDs[0]}]
set_property PACKAGE_PIN E19 [get_ports {addr_LEDs[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_LEDs[1]}]
set_property PACKAGE_PIN U19 [get_ports {addr_LEDs[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_LEDs[2]}]
set_property PACKAGE_PIN V19 [get_ports {addr_LEDs[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {addr_LEDs[3]}]
#set_property PACKAGE_PIN W18 [get_ports {master_reset}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {master_reset}]
...
set_property PACKAGE_PIN U18 [get_ports enter_data]						
	set_property IOSTANDARD LVCMOS33 [get_ports enter_data]
set_property PACKAGE_PIN T18 [get_ports run_checksum]						
	set_property IOSTANDARD LVCMOS33 [get_ports run_checksum]
set_property PACKAGE_PIN W19 [get_ports previous_data]						
	set_property IOSTANDARD LVCMOS33 [get_ports previous_data]
set_property PACKAGE_PIN T17 [get_ports next_data]						
	set_property IOSTANDARD LVCMOS33 [get_ports next_data]
set_property PACKAGE_PIN U17 [get_ports display_counter]						
	set_property IOSTANDARD LVCMOS33 [get_ports display_counter]
